...
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI) real vx uvx norm.html" 

#INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NC) sim_NOBIAS_Vesely_106_202403141131.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NC) sim NOBIAS vx uvx norm.html" 

# INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NP) sim_MINBIAS deathday_gr_doseday_random Vesely_106_202403141131.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NP) sim MINBIAS deathday_gr_doseday_random vx uvx norm.html" 

# INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NK) sim_MINBIAS_deathday_gr_doseday_Vesely_106_202403141131.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NK) sim MINBIAS deathday_gr_doseday vx uvx norm.html"

# INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NO) sim minbias deathday_gr_doseday Vesely_106_202403141131.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NO) sim MINBIAS deathday_gr_doseday vx uvx norm.html"
...
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NO) sim randomly_assign_first_doses deathday_gr_doseday vx uvx norm.html" 

# INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NQ) sim link nearest random neighbour only death Vesely_106_202403141131.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NQ) sim link nearest random neigbour only death vx uvx norm.html"

# INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NU) sim link nearest random neighbour whole pop Vesely_106_202403141131.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NU) sim link nearest random neighbour whole pop vx uvx norm.html"

# INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NW) sim link nearest random neighbour only deaths Vesely_106_202403141131.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NW) sim link nearest random neighbour only deaths vx uvx norm.html"

# INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NV) real not link nearest random neighbour only death Vesely_106_202403141131.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NV) real not link nearest random neighbour only death vx uvx norm.html"

# INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NR) sim random doses Vesely_106_202403141131_doses.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NR) sim random doses vx uvx norm.html"

# INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NT) sim random deaths Vesely_106_202403141131.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NT) sim random deaths vx uvx norm.html"

# INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NX) sim random deaths and doses Vesely_106_202403141131.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NX) sim random deaths and doses vx uvx norm.html"

# INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\NY) sim random all doses Vesely_106_202403141131_doses.csv"
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-NY) sim random all doses vx uvx norm.html"

#INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\SIM_CASES\#case2_sim_deaths_real_doses_no_constraint.csv"
#OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI) #case2_sim_deaths_real_doses_no_constraint vx uvx norm.html"

#INPUT_CSV = r"C:\CzechFOI-DRATE_EXAM\TERRA\SIM_CASES\case4_sim_deaths_sim_doses_real_schedule_no_constraint.csv"
#OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI- case4_sim_deaths_sim_doses_real_schedule_no_constraint.html"
...
# OUTPUT_HTML = r"C:\CzechFOI-DRATE_EXAM\Plot Results\ZI) vx uvx norm\ZI-AA) sim randomly assign_first_doses deathday_gr_doseday.html"
